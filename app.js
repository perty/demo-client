...
var _kevinbgreene$elm_tutorial$Main$header = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Demo client'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://curity-slave-oauth-test1.ocp.hh.atg.se/oauth/authorize?client_id=atg&response_type=code&scope=read&redirect_uri=http://localhost:8080/code'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _kevinbgreene$elm_tutorial$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _kevinbgreene$elm_tutorial$Main$header,
			_1: {
				ctor: '::',
				_0: _kevinbgreene$elm_tutorial$Main$viewData(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _kevinbgreene$elm_tutorial$Main$homeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: _evancz$url_parser$UrlParser$s('index.html'),
		_1: {
			ctor: '::',
			_0: _evancz$url_parser$UrlParser$s(''),
			_1: {ctor: '[]'}
		}
	});
var _kevinbgreene$elm_tutorial$Main$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'Update message: ', msg);
		var _p1 = _p0._0;
		switch (_p1.ctor) {
			case 'CodeRoute':
				return {
...
var _kevinbgreene$elm_tutorial$Main$NotFound = {ctor: 'NotFound'};
var _kevinbgreene$elm_tutorial$Main$JwtRoute = function (a) {
	return {ctor: 'JwtRoute', _0: a};
};
var _kevinbgreene$elm_tutorial$Main$TokenRoute = function (a) {
	return {ctor: 'TokenRoute', _0: a};
};
var _kevinbgreene$elm_tutorial$Main$CodeRoute = function (a) {
...
var _kevinbgreene$elm_tutorial$Main$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _kevinbgreene$elm_tutorial$Main$HomeRoute, _kevinbgreene$elm_tutorial$Main$homeParser),
		_1: {
			ctor: '::',
			_0: A2(_evancz$url_parser$UrlParser$map, _kevinbgreene$elm_tutorial$Main$CodeRoute, _kevinbgreene$elm_tutorial$Main$codeParser),
			_1: {
				ctor: '::',
				_0: A2(_evancz$url_parser$UrlParser$map, _kevinbgreene$elm_tutorial$Main$TokenRoute, _kevinbgreene$elm_tutorial$Main$tokenParser),
				_1: {
					ctor: '::',
					_0: A2(_evancz$url_parser$UrlParser$map, _kevinbgreene$elm_tutorial$Main$JwtRoute, _kevinbgreene$elm_tutorial$Main$jwtParser),
					_1: {ctor: '[]'}
				}
			}
		}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _kevinbgreene$elm_tutorial$Main$main !== 'undefined') {
    _kevinbgreene$elm_tutorial$Main$main(Elm['Main'], 'Main', undefined);
}
